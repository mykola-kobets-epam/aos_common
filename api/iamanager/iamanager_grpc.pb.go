...
type IAMPublicServiceClient interface {
	GetAPIVersion(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*APIVersion, error)
...
func (c *iAMPublicServiceClient) GetAPIVersion(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*APIVersion, error) {
	out := new(APIVersion)
	err := c.cc.Invoke(ctx, "/iamanager.v5.IAMPublicService/GetAPIVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IAMPublicServiceServer interface {
	GetAPIVersion(context.Context, *emptypb.Empty) (*APIVersion, error)
...
func (UnimplementedIAMPublicServiceServer) GetAPIVersion(context.Context, *emptypb.Empty) (*APIVersion, error) {
...
func _IAMPublicService_GetAPIVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iamanager.v5.IAMPublicService/GetAPIVersion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IAMPublicServiceServer).GetAPIVersion(ctx, req.(*emptypb.Empty))
	}
