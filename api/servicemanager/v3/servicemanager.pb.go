...
type SMIncomingMessages struct {
	...
	//	*SMIncomingMessages_InstanceStateAcceptance
	//	*SMIncomingMessages_SetInstanceState
...
func (x *SMIncomingMessages) GetInstanceStateAcceptance() *InstanceStateAcceptance {
	if x, ok := x.GetSMIncomingMessage().(*SMIncomingMessages_InstanceStateAcceptance); ok {
		return x.InstanceStateAcceptance
	}
	return nil
}

func (x *SMIncomingMessages) GetSetInstanceState() *SetInstanceState {
	if x, ok := x.GetSMIncomingMessage().(*SMIncomingMessages_SetInstanceState); ok {
		return x.SetInstanceState
	}
	return nil
}
...
type SMIncomingMessages_InstanceStateAcceptance struct {
	InstanceStateAcceptance *InstanceStateAcceptance `protobuf:"bytes,5,opt,name=instance_state_acceptance,json=instanceStateAcceptance,proto3,oneof"`
}

type SMIncomingMessages_SetInstanceState struct {
	SetInstanceState *SetInstanceState `protobuf:"bytes,6,opt,name=set_instance_state,json=setInstanceState,proto3,oneof"`
}

type SMIncomingMessages_OverrideEnvVars struct {
	OverrideEnvVars *OverrideEnvVars `protobuf:"bytes,7,opt,name=override_env_vars,json=overrideEnvVars,proto3,oneof"`
}

type SMIncomingMessages_SystemLogRequest struct {
	SystemLogRequest *SystemLogRequest `protobuf:"bytes,8,opt,name=system_log_request,json=systemLogRequest,proto3,oneof"`
}

type SMIncomingMessages_InstanceLogRequest struct {
	InstanceLogRequest *InstanceLogRequest `protobuf:"bytes,9,opt,name=instance_log_request,json=instanceLogRequest,proto3,oneof"`
}

type SMIncomingMessages_InstanceCrashLogRequest struct {
	InstanceCrashLogRequest *InstanceCrashLogRequest `protobuf:"bytes,10,opt,name=instance_crash_log_request,json=instanceCrashLogRequest,proto3,oneof"`
}

type SMIncomingMessages_GetNodeMonitoring struct {
	GetNodeMonitoring *GetNodeMonitoring `protobuf:"bytes,11,opt,name=get_node_monitoring,json=getNodeMonitoring,proto3,oneof"`
}
...
func (*SMIncomingMessages_InstanceStateAcceptance) isSMIncomingMessages_SMIncomingMessage() {}

func (*SMIncomingMessages_SetInstanceState) isSMIncomingMessages_SMIncomingMessage() {}
...
type InstanceStateAcceptance struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InstanceStateAcceptance) Reset() {
	*x = InstanceStateAcceptance{}
	if protoimpl.UnsafeEnabled {
...
func (x *InstanceStateAcceptance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InstanceStateAcceptance) ProtoMessage() {}

func (x *InstanceStateAcceptance) ProtoReflect() protoreflect.Message {
	mi := &file_servicemanager_v3_servicemanager_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InstanceStateAcceptance.ProtoReflect.Descriptor instead.
func (*InstanceStateAcceptance) Descriptor() ([]byte, []int) {
	return file_servicemanager_v3_servicemanager_proto_rawDescGZIP(), []int{9}
}

func (x *InstanceStateAcceptance) GetInstance() *InstanceIdent {
	if x != nil {
		return x.Instance
	}
	return nil
...
func (x *InstanceStateAcceptance) GetStateChecksum() string {
	if x != nil {
...
func (x *InstanceStateAcceptance) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
func (x *InstanceStateAcceptance) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *SetInstanceState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetInstanceState) ProtoMessage() {}

func (x *SetInstanceState) ProtoReflect() protoreflect.Message {
	mi := &file_servicemanager_v3_servicemanager_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetInstanceState.ProtoReflect.Descriptor instead.
func (*SetInstanceState) Descriptor() ([]byte, []int) {
	return file_servicemanager_v3_servicemanager_proto_rawDescGZIP(), []int{10}
}

func (x *SetInstanceState) GetState() *InstanceState {
	if x != nil {
		return x.State
	}
	return nil
...
type SMOutgoingMessages struct {
	...
	//	*SMOutgoingMessages_InstanceStateRequest
	//	*SMOutgoingMessages_NewInstanceState
...
func (x *SMOutgoingMessages) GetInstanceStateRequest() *InstanceStateRequest {
	if x, ok := x.GetSMOutgoingMessage().(*SMOutgoingMessages_InstanceStateRequest); ok {
		return x.InstanceStateRequest
	}
	return nil
}

func (x *SMOutgoingMessages) GetNewInstanceState() *NewInstanceState {
	if x, ok := x.GetSMOutgoingMessage().(*SMOutgoingMessages_NewInstanceState); ok {
...
type SMOutgoingMessages_InstanceStateRequest struct {
	InstanceStateRequest *InstanceStateRequest `protobuf:"bytes,5,opt,name=instance_state_request,json=instanceStateRequest,proto3,oneof"`
}

type SMOutgoingMessages_NewInstanceState struct {
	NewInstanceState *NewInstanceState `protobuf:"bytes,6,opt,name=new_instance_state,json=newInstanceState,proto3,oneof"`
}

type SMOutgoingMessages_OverrideEnvVarStatus struct {
	OverrideEnvVarStatus *OverrideEnvVarStatus `protobuf:"bytes,7,opt,name=override_env_var_status,json=overrideEnvVarStatus,proto3,oneof"`
}

type SMOutgoingMessages_Log struct {
	Log *LogData `protobuf:"bytes,8,opt,name=log,proto3,oneof"`
}

type SMOutgoingMessages_NodeMonitoring struct {
	NodeMonitoring *NodeMonitoring `protobuf:"bytes,9,opt,name=node_monitoring,json=nodeMonitoring,proto3,oneof"`
}
...
func (*SMOutgoingMessages_InstanceStateRequest) isSMOutgoingMessages_SMOutgoingMessage() {}

func (*SMOutgoingMessages_NewInstanceState) isSMOutgoingMessages_SMOutgoingMessage() {}
...
type NodeConfiguration struct {
	...
	RemoteNode     bool         `protobuf:"varint,2,opt,name=remote_node,json=remoteNode,proto3" json:"remote_node,omitempty"`
	RunnerFeatures []string     `protobuf:"bytes,3,rep,name=runner_features,json=runnerFeatures,proto3" json:"runner_features,omitempty"`
	NumCpus        uint64       `protobuf:"varint,4,opt,name=num_cpus,json=numCpus,proto3" json:"num_cpus,omitempty"`
	TotalRam       uint64       `protobuf:"varint,5,opt,name=total_ram,json=totalRam,proto3" json:"total_ram,omitempty"`
...
var file_servicemanager_v3_servicemanager_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf2, 0x07, 0x0a,
	...
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x12, 0x68, 0x0a, 0x19, 0x69, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x70,
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x73, 0x65,
	...
	,
	...
	,
	...
	0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x64, 0x65, 0x4d, 0x6f, 0x6e,
	0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x48, 0x00, 0x52, 0x11, 0x67, 0x65, 0x74, 0x4e, 0x6f,
	0x64, 0x65, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x42, 0x13, 0x0a, 0x11,
	...
	0x65, 0x6e, 0x64, 0x6f, 0x72, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xbf, 0x01, 0x0a,
	0x0c, 0x52, 0x75, 0x6e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x12, 0x3a, 0x0a,
	...
	0x2e, 0x76, 0x33, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52,
	0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x34, 0x0a, 0x06, 0x6c, 0x61, 0x79,
	0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x4c, 0x61,
	0x79, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x12,
	0x3d, 0x0a, 0x09, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x09, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x22, 0xf7,
	0x01, 0x0a, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x40,
	0x0a, 0x0c, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x6d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x56, 0x65, 0x73, 0x69, 0x6f, 0x6e, 0x49,
	...
	,
	...
	0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x73, 0x68, 0x61, 0x35, 0x31, 0x32, 0x12, 0x12, 0x0a,
	0x04, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x73, 0x69, 0x7a,
	0x65, 0x22, 0x76, 0x0a, 0x0a, 0x56, 0x65, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	0x1f, 0x0a, 0x0b, 0x61, 0x6f, 0x73, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01,
	...
	0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72,
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72,
	0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x65,
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xbc, 0x01, 0x0a, 0x0c, 0x49, 0x6e,
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x3c, 0x0a, 0x08, 0x69, 0x6e,
	...
	,
	...
	0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x4a, 0x0a, 0x10, 0x53, 0x65, 0x74,
	0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x36, 0x0a,
	...
	0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x57, 0x0a, 0x0f, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64,
	...
	0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x22, 0xdc, 0x06, 0x0a, 0x12, 0x53, 0x4d, 0x4f, 0x75,
	...
	0x63, 0x65, 0x73, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x5f, 0x0a, 0x16, 0x69, 0x6e, 0x73,
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x4e, 0x65, 0x77, 0x49, 0x6e,
	...
	0x76, 0x61, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b,
	...
	0x73, 0x12, 0x2e, 0x0a, 0x03, 0x6c, 0x6f, 0x67, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e,
	...
	0x72, 0x69, 0x6e, 0x67, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x4e,
	...
	0x30, 0x0a, 0x05, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xec, 0x01, 0x0a, 0x11, 0x4e, 0x6f, 0x64, 0x65, 0x43,
	...
	0x6f, 0x64, 0x65, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x5f,
	0x6e, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x72, 0x65, 0x6d, 0x6f,
	...
	0x19, 0x0a, 0x08, 0x6e, 0x75, 0x6d, 0x5f, 0x63, 0x70, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x07, 0x6e, 0x75, 0x6d, 0x43, 0x70, 0x75, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x6f,
	0x74, 0x61, 0x6c, 0x5f, 0x72, 0x61, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x74,
	0x6f, 0x74, 0x61, 0x6c, 0x52, 0x61, 0x6d, 0x12, 0x3c, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x74, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e,
	...
	0x52, 0x09, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x22, 0xf0, 0x01, 0x0a, 0x0e,
	...
	,
	...
	,
...
var file_servicemanager_v3_servicemanager_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_servicemanager_v3_servicemanager_proto_goTypes = []interface{}{
	...
	(*InstanceStateAcceptance)(nil), // 9: servicemanager.v3.InstanceStateAcceptance
	(*SetInstanceState)(nil),        // 10: servicemanager.v3.SetInstanceState
	...
	(*InstanceStateRequest)(nil),    // 27: servicemanager.v3.InstanceStateRequest
	(*NewInstanceState)(nil),        // 28: servicemanager.v3.NewInstanceState
	(*InstanceState)(nil),           // 29: servicemanager.v3.InstanceState
...
var file_servicemanager_v3_servicemanager_proto_depIdxs = []int32{
	...
	9,  // 4: servicemanager.v3.SMIncomingMessages.instance_state_acceptance:type_name -> servicemanager.v3.InstanceStateAcceptance
	10, // 5: servicemanager.v3.SMIncomingMessages.set_instance_state:type_name -> servicemanager.v3.SetInstanceState
	11, // 6: servicemanager.v3.SMIncomingMessages.override_env_vars:type_name -> servicemanager.v3.OverrideEnvVars
	14, // 7: servicemanager.v3.SMIncomingMessages.system_log_request:type_name -> servicemanager.v3.SystemLogRequest
	15, // 8: servicemanager.v3.SMIncomingMessages.instance_log_request:type_name -> servicemanager.v3.InstanceLogRequest
	16, // 9: servicemanager.v3.SMIncomingMessages.instance_crash_log_request:type_name -> servicemanager.v3.InstanceCrashLogRequest
	17, // 10: servicemanager.v3.SMIncomingMessages.get_node_monitoring:type_name -> servicemanager.v3.GetNodeMonitoring
	5,  // 11: servicemanager.v3.RunInstances.services:type_name -> servicemanager.v3.ServiceInfo
	6,  // 12: servicemanager.v3.RunInstances.layers:type_name -> servicemanager.v3.LayerInfo
	8,  // 13: servicemanager.v3.RunInstances.instances:type_name -> servicemanager.v3.InstanceInfo
	7,  // 14: servicemanager.v3.ServiceInfo.version_info:type_name -> servicemanager.v3.VesionInfo
	7,  // 15: servicemanager.v3.LayerInfo.version_info:type_name -> servicemanager.v3.VesionInfo
	25, // 16: servicemanager.v3.InstanceInfo.instance:type_name -> servicemanager.v3.InstanceIdent
	25, // 17: servicemanager.v3.InstanceStateAcceptance.instance:type_name -> servicemanager.v3.InstanceIdent
	29, // 18: servicemanager.v3.SetInstanceState.state:type_name -> servicemanager.v3.InstanceState
	12, // 19: servicemanager.v3.OverrideEnvVars.env_vars:type_name -> servicemanager.v3.OverrideInstanceEnvVar
	25, // 20: servicemanager.v3.OverrideInstanceEnvVar.instance:type_name -> servicemanager.v3.InstanceIdent
	13, // 21: servicemanager.v3.OverrideInstanceEnvVar.vars:type_name -> servicemanager.v3.EnvVarInfo
	47, // 22: servicemanager.v3.EnvVarInfo.ttl:type_name -> google.protobuf.Timestamp
	47, // 23: servicemanager.v3.SystemLogRequest.from:type_name -> google.protobuf.Timestamp
	47, // 24: servicemanager.v3.SystemLogRequest.till:type_name -> google.protobuf.Timestamp
	25, // 25: servicemanager.v3.InstanceLogRequest.instance:type_name -> servicemanager.v3.InstanceIdent
	47, // 26: servicemanager.v3.InstanceLogRequest.from:type_name -> google.protobuf.Timestamp
	47, // 27: servicemanager.v3.InstanceLogRequest.till:type_name -> google.protobuf.Timestamp
	25, // 28: servicemanager.v3.InstanceCrashLogRequest.instance:type_name -> servicemanager.v3.InstanceIdent
	47, // 29: servicemanager.v3.InstanceCrashLogRequest.from:type_name -> google.protobuf.Timestamp
	47, // 30: servicemanager.v3.InstanceCrashLogRequest.till:type_name -> google.protobuf.Timestamp
	19, // 31: servicemanager.v3.SMOutgoingMessages.node_configuration:type_name -> servicemanager.v3.NodeConfiguration
	21, // 32: servicemanager.v3.SMOutgoingMessages.unit_config_status:type_name -> servicemanager.v3.UnitConfigStatus
	22, // 33: servicemanager.v3.SMOutgoingMessages.run_instances_status:type_name -> servicemanager.v3.RunInstancesStatus
	23, // 34: servicemanager.v3.SMOutgoingMessages.update_instances_status:type_name -> servicemanager.v3.UpdateInstancesStatus
	27, // 35: servicemanager.v3.SMOutgoingMessages.instance_state_request:type_name -> servicemanager.v3.InstanceStateRequest
	28, // 36: servicemanager.v3.SMOutgoingMessages.new_instance_state:type_name -> servicemanager.v3.NewInstanceState
	...
	20, // 41: servicemanager.v3.NodeConfiguration.partitions:type_name -> servicemanager.v3.Partition
	24, // 42: servicemanager.v3.RunInstancesStatus.instances:type_name -> servicemanager.v3.InstanceStatus
	24, // 43: servicemanager.v3.UpdateInstancesStatus.instances:type_name -> servicemanager.v3.InstanceStatus
	25, // 44: servicemanager.v3.InstanceStatus.instance:type_name -> servicemanager.v3.InstanceIdent
	26, // 45: servicemanager.v3.InstanceStatus.error_info:type_name -> servicemanager.v3.ErrorInfo
	25, // 46: servicemanager.v3.InstanceStateRequest.instance:type_name -> servicemanager.v3.InstanceIdent
	29, // 47: servicemanager.v3.NewInstanceState.state:type_name -> servicemanager.v3.InstanceState
	25, // 48: servicemanager.v3.InstanceState.instance:type_name -> servicemanager.v3.InstanceIdent
	31, // 49: servicemanager.v3.OverrideEnvVarStatus.env_vars_status:type_name -> servicemanager.v3.EnvVarInstanceStatus
	25, // 50: servicemanager.v3.EnvVarInstanceStatus.instance:type_name -> servicemanager.v3.InstanceIdent
	32, // 51: servicemanager.v3.EnvVarInstanceStatus.vars_status:type_name -> servicemanager.v3.EnvVarStatus
	47, // 52: servicemanager.v3.NodeMonitoring.timestamp:type_name -> google.protobuf.Timestamp
	35, // 53: servicemanager.v3.NodeMonitoring.monitoringData:type_name -> servicemanager.v3.MonitoringData
	37, // 54: servicemanager.v3.NodeMonitoring.instance_monitoring:type_name -> servicemanager.v3.InstanceMonitoring
	36, // 55: servicemanager.v3.MonitoringData.disk:type_name -> servicemanager.v3.PartitionUsage
	25, // 56: servicemanager.v3.InstanceMonitoring.instance:type_name -> servicemanager.v3.InstanceIdent
	35, // 57: servicemanager.v3.InstanceMonitoring.monitoringData:type_name -> servicemanager.v3.MonitoringData
	47, // 58: servicemanager.v3.Alert.timestamp:type_name -> google.protobuf.Timestamp
	39, // 59: servicemanager.v3.Alert.system_quota_alert:type_name -> servicemanager.v3.SystemQuotaAlert
	40, // 60: servicemanager.v3.Alert.instance_quota_alert:type_name -> servicemanager.v3.InstanceQuotaAlert
	42, // 61: servicemanager.v3.Alert.resource_validate_alert:type_name -> servicemanager.v3.ResourceValidateAlert
	41, // 62: servicemanager.v3.Alert.device_allocate_alert:type_name -> servicemanager.v3.DeviceAllocateAlert
	44, // 63: servicemanager.v3.Alert.system_alert:type_name -> servicemanager.v3.SystemAlert
	45, // 64: servicemanager.v3.Alert.core_alert:type_name -> servicemanager.v3.CoreAlert
	46, // 65: servicemanager.v3.Alert.instance_alert:type_name -> servicemanager.v3.InstanceAlert
	25, // 66: servicemanager.v3.InstanceQuotaAlert.instance:type_name -> servicemanager.v3.InstanceIdent
	25, // 67: servicemanager.v3.DeviceAllocateAlert.instance:type_name -> servicemanager.v3.InstanceIdent
	43, // 68: servicemanager.v3.ResourceValidateAlert.errors:type_name -> servicemanager.v3.ResourceValidateErrors
	25, // 69: servicemanager.v3.InstanceAlert.instance:type_name -> servicemanager.v3.InstanceIdent
	18, // 70: servicemanager.v3.SMService.RegisterSM:input_type -> servicemanager.v3.SMOutgoingMessages
	0,  // 71: servicemanager.v3.SMService.RegisterSM:output_type -> servicemanager.v3.SMIncomingMessages
...
func file_servicemanager_v3_servicemanager_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_servicemanager_v3_servicemanager_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InstanceStateAcceptance); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_servicemanager_v3_servicemanager_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*SMIncomingMessages_InstanceStateAcceptance)(nil),
		(*SMIncomingMessages_SetInstanceState)(nil),
	...
	file_servicemanager_v3_servicemanager_proto_msgTypes[18].OneofWrappers = []interface{}{
		...
		(*SMOutgoingMessages_InstanceStateRequest)(nil),
		(*SMOutgoingMessages_NewInstanceState)(nil),
	...
	file_servicemanager_v3_servicemanager_proto_msgTypes[38].OneofWrappers = []interface{}{
